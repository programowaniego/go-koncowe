...
plansza* utworz_plansze(plansza* nowa,char gracz[2],int wypelnienie,char* tab[wiersze * kolumny]){
    ...
    for(int i = 0;wypelnienie == 0 && i < wiersze * kolumny ;i++)
        nowa_plansza->wartosci[i] = " ";

    for(int i = 0;wypelnienie == 1 && i < wiersze * kolumny;i++)
        nowa_plansza->wartosci[i] = tab[i];
